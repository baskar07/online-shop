    ...
    <div class="bg-white rounded-xl shadow-cardbox relative overflow-hidden w-[900px] max-w-full min-h-[580px]">
      <div className="absolute top-0 h-full transition-all right-0 w-[50%] z-1 bg-white px-[50px]  ">
        <div className="my-[2rem] mx-auto ">
          <h2 className="font-medium text-[30px] mb-[20px] text-center text-orange-400">Sign Up</h2>
          <form action="" className="flex flex-col">
            <input type="text" placeholder="Enter your name" className="bg-[#eee] border-none p-[15px] my-[8px] w-full outline-none text-[15px]" />
            ...
            <input  type="hidden" placeholder="Enter your otp" className="bg-[#eee] border-none p-[15px] my-[8px] w-full outline-none text-[15px]"/>
            <button className=" rounded-[20px] border-[1px] border-[#6c63ff] bg-[#6c63ff] text-white text-[14px] font-medium px-[45px] py-[12px] uppercase mt-4">Sign Up</button>
          </form>
          <p className="ml-5 mt-2">
            Already have you account? <Link to='/login' className="ml-2.5 text-[rgb(30,68,194)]">signin</Link>
          </p>
